...
class AgentCourt(gl.Contract):
    ...
    def cancel_dispute(self, dispute_id: u256) -> None:
        ...
        the full escrow is refunded by message emission. Once the
        defendant pins the work, only a trial may release the funds.
        """
        d = self._load(dispute_id)
    ...
    def finalize(self, dispute_id: u256) -> None:
        ...
        emitted to the parties — executed on-chain at finality.
        """
        d = self._load(dispute_id)
