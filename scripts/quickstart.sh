...
# 3 · get test GEN from the Studio account selector (💧)
...
# satisfied? both parties accept, then anyone settles.
# Without mutual acceptance, wait for settlement_status.window_closed.
genlayer write 0xCOURT accept_verdict 0
